...
class CarRequestModel {
  ...
  factory CarRequestModel.fromJson(String str) => CarRequestModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory CarRequestModel.fromMap(Map<String, dynamic> json) => CarRequestModel(
