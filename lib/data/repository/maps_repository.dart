...
import 'package:shaft_rent/data/model/response/admin/maps/add_maps_response_model.dart';
import 'package:shaft_rent/data/model/response/admin/maps/delete_maps_response_model.dart';
import 'package:shaft_rent/data/model/response/admin/maps/update_maps_response_model.dart';
...
class MapsRepository {
  ...
  final String _googleMapsApiKey = 'AIzaSyDibqZy4BQxwm3oM1BS57VmEEhKH_Ug1fU';
