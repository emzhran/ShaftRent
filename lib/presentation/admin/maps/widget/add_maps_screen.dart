...
import 'package:shaft_rent/presentation/admin/maps/addmaps/addmaps_bloc.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          BlocConsumer<AddMapsBloc, AddMapsState>(
            listener: (context, state) {
              if (state is AddMapsSuccess) {
                Navigator.of(context).pop(true);
              } else if (state is AddMapsError) {
            ...
            builder: (context, state) {
              final isLoading = state is AddMapsLoading;
              return Padding(
                padding: const EdgeInsets.all(16),
                child: ElevatedButton(
                  ...
                  onPressed: isLoading
                        ...
                        : () {
                          ...
                          context.read<AddMapsBloc>().add(AddMaps(requestModel: request)
                          );
                        }, 
