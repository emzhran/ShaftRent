...
import 'package:shaft_rent/presentation/admin/maps/updatemaps/updatemaps_bloc.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          BlocConsumer<UpdateMapsBloc, UpdateMapsState>(
            listener: (context, state) {
              if (state is UpdateMapsSuccess) {
                Navigator.of(context).pop(true);
              } else if (state is UpdateMapsError) {
            ...
            builder: (context, state) {
              final isLoading = state is UpdateMapsLoading;
              return Padding(
                padding: const EdgeInsets.all(16),
                child: ElevatedButton(
                  ...
                  onPressed: isLoading
                      ...
                      : () {
                          ...
                          context.read<UpdateMapsBloc>().add(
                                UpdateMaps(mapId: widget.map.id, requestModel: request),
                              );
                        },
